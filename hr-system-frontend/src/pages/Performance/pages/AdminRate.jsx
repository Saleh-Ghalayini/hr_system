             ...
             
                 {
                    users.map( (user)=>{
                        return (
                            ...
                            <div className="user flex flex-dir-row align-center " onClick={()=>{
                            ...
                            <div className={`performance-form flex flex-dir-row flex-wrap ${userid == user.id ? "": "display-none"}`} >
                            <Input
                            label={"Team Work"}
                            type={"number"}
                            ...
                            />
                              ...
                              <Button className={`btn ${userid == user.id ? "": "display-none"}`} text={"Rate"} onClick={()=>{
                                rateEmploye(user.id)
                              }} />
                            </div>
                             </>
